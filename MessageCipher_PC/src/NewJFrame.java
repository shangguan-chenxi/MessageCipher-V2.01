...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPublicKeyEncrypt = new javax.swing.JButton();
        btnPublicKeyDecrypt = new javax.swing.JButton();
        ...
        btnPrivateKeyEncrypt = new javax.swing.JButton();
        btnPrivateKeyDecrypt = new javax.swing.JButton();
        ...
        hintAesPwdFormat.setText("AES密码(16/24/32字符长度):");

        hintPublicKey.setText("RSA公钥(发送给他人的密钥)");
        ...
        btnPublicKeyEncrypt.setText("公钥加密");
        btnPublicKeyEncrypt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPublicKeyEncryptActionPerformed(evt);
            }
        });

        btnPublicKeyDecrypt.setText("公钥解密");
        btnPublicKeyDecrypt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPublicKeyDecryptActionPerformed(evt);
            }
        });
        ...
        hintPrivateKey.setText("RSA私钥(务必保证私钥安全)");
        ...
        btnPrivateKeyEncrypt.setText("私钥加密");
        btnPrivateKeyEncrypt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrivateKeyEncryptActionPerformed(evt);
            }
        });

        btnPrivateKeyDecrypt.setText("私钥解密");
        btnPrivateKeyDecrypt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPrivateKeyDecryptActionPerformed(evt);
            }
        });
        ...
        hintSignature.setText("数字签名(用私钥生成)");

        btnSign.setText("生成签名");
        ...
        hintEncryptedTxt.setText("密文(接收到的或要发送的)");
        ...
        hintAesPlainText.setText("AES明文");
        ...
        hintAesEncryptedText.setText("AES密文");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                ...
                                                .addGroup(layout.createSequentialGroup()
                                                    .addComponent(btnPrivateKeyEncrypt)
                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                    .addComponent(btnClearPrivateKey))
                                                .addComponent(btnPrivateKeyDecrypt)
                                                ...
                                                .addGroup(layout.createSequentialGroup()
                                                    .addComponent(btnPublicKeyEncrypt)
                                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                    .addComponent(btnClearPublicKey))
                                                .addComponent(btnPublicKeyDecrypt)
                                                .addComponent(hintEncryptedTxt))
                                            .addComponent(btnClearEncryptedText, javax.swing.GroupLayout.Alignment.TRAILING))
                                        .addGap(18, 18, 18)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(txtAesPwd, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnGenRandAesPwd, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnGenRandAesPwdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenRandAesPwdActionPerformed
        ...
        // 弹窗提示AES密码
        JOptionPane.showConfirmDialog(null, (new String(txtAesPwd.getPassword())), "AES明文密码", JOptionPane.OK_OPTION);
        // 获取密码框内容
    ...
    private void btnPublicKeyDecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPublicKeyDecryptActionPerformed

        // 取得公钥
        String public_key = txtPublicKey.getText();
        
        // 取得密文
        String encrypted_text = txtEncryptedTxt.getText();
        
        // 判断公钥和密文为不为空
        if ("".equals(public_key) || public_key == null){
            JOptionPane.showMessageDialog(null, "需要提供公钥", "错误", JOptionPane.ERROR_MESSAGE);
        }else if ("".equals(encrypted_text) || encrypted_text == null){
            JOptionPane.showMessageDialog(null, "需要提供密文", "错误", JOptionPane.ERROR_MESSAGE);
        }else{
            String result = decryptByPublicKey(encrypted_text, public_key);
            if (!"".equals(result)){
                // 写到AES密码框中
                txtAesPwd.setText(result);
                // 弹窗提示AES密码
                JOptionPane.showConfirmDialog(null, result, "AES明文密码", JOptionPane.OK_OPTION);
            }else{
                // 提示错误
                JOptionPane.showMessageDialog(null, "使用公钥解密时发生错误", "错误", JOptionPane.ERROR_MESSAGE);
            }
        } 
    }//GEN-LAST:event_btnPublicKeyDecryptActionPerformed

    private void btnPrivateKeyEncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrivateKeyEncryptActionPerformed
        // TODO add your handling code here:
        // 取得AES明文
        String plain_text = new String(txtAesPwd.getPassword());
        // 取得私钥
        String private_key = txtPrivateKey.getText();
        
        // 判断私钥和明文不为空
        if ("".equals(plain_text) || plain_text == null){
            JOptionPane.showMessageDialog(null, "需要提供AES明文密码", "错误", JOptionPane.ERROR_MESSAGE);
        }else if(plain_text.length() != 16 && plain_text.length() != 24 && plain_text.length() != 32){
            JOptionPane.showMessageDialog(null, "密码应为16/24/32字符长度", "错误", JOptionPane.ERROR_MESSAGE);
        }else if("".equals(private_key) || private_key == null){
            JOptionPane.showMessageDialog(null, "需要提供私钥", "错误", JOptionPane.ERROR_MESSAGE);
        }else{
            String result = encryptByPrivateKey(plain_text, private_key);
            if (!"".equals(result) || null != result){
                // 设置密文框内容
                txtEncryptedTxt.setText(result);
            }else{
                JOptionPane.showMessageDialog(null, "使用私钥加密时发生错误", "错误", JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_btnPrivateKeyEncryptActionPerformed
    ...
    private void btnSignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignActionPerformed
        ...
        // 判断都不为空
        if ("".equals(private_key) || private_key == null){
            JOptionPane.showMessageDialog(null, "需要提供私钥", "错误", JOptionPane.ERROR_MESSAGE);
        }else{
            if("".equals(encrypted_text) || encrypted_text == null){
                if(aes_pwd.length() != 16 && aes_pwd.length() != 24 && aes_pwd.length() != 32){
                    JOptionPane.showMessageDialog(null, "密码应为16/24/32字符长度", "错误", JOptionPane.ERROR_MESSAGE);
                }else{
                    // 私钥加密AES密码
                    txtEncryptedTxt.setText(encryptByPrivateKey(aes_pwd, private_key));
                    // 获得密文
                    encrypted_text = txtEncryptedTxt.getText();
                    // 对密文签名
                    txtSignature.setText(sign(encrypted_text, private_key));
                }
            }else{
                // 对密文签名
                txtSignature.setText(sign(encrypted_text, private_key));
    ...
    private void btnPublicKeyEncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPublicKeyEncryptActionPerformed
        // 获取公钥
        String public_key = txtPublicKey.getText();
        // 获取aes pwd明文
        String plain_text = new String(txtAesPwd.getPassword());
        ...
        if("".equals(public_key) || public_key == null){
            JOptionPane.showMessageDialog(null, "需要提供公钥", "错误", JOptionPane.ERROR_MESSAGE);
        }else if("".equals(plain_text) || plain_text == null){
            JOptionPane.showMessageDialog(null, "需要提供密文", "错误", JOptionPane.ERROR_MESSAGE);
        }else{
            String result = encryptByPublicKey(plain_text, public_key);
            if (null != result || !"".equals(result)){
                // 设置密文框内容
                txtEncryptedTxt.setText(result);
            }else{
                JOptionPane.showMessageDialog(null, "使用公钥加密时发生错误", "错误", JOptionPane.ERROR_MESSAGE);
            }
        }
        
    }//GEN-LAST:event_btnPublicKeyEncryptActionPerformed

    private void btnPrivateKeyDecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrivateKeyDecryptActionPerformed
        // TODO add your handling code here:
        // 取得私钥
        String private_key = txtPrivateKey.getText();
        // 取得密文
        ...
        if("".equals(private_key) || private_key == null){
            ...
            String result = decryptByPrivateKey(encrypted_text, private_key);
            if (!"".equals(result) || null != result){
                // 写到AES密码框中
                txtAesPwd.setText(result);
                // 弹窗提示AES密码
                ...
                JOptionPane.showMessageDialog(null, "使用私钥解密时发生错误", "错误", JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_btnPrivateKeyDecryptActionPerformed
    ...
    private void btnVerifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerifyActionPerformed
        ...
        if ("".equals(public_key) || public_key == null){
            JOptionPane.showMessageDialog(null, "需要提供公钥", "错误", JOptionPane.ERROR_MESSAGE);
        }else if ("".equals(signature) || signature == null){
            JOptionPane.showMessageDialog(null, "需要提供签名", "错误", JOptionPane.ERROR_MESSAGE);
        }else if ("".equals(encrypted_text) || encrypted_text == null){
            JOptionPane.showMessageDialog(null, "需要提供密文", "错误", JOptionPane.ERROR_MESSAGE);
        }else{
            boolean result = verify(encrypted_text, public_key, signature);
            if (result == true){
                // 设置aes pwd内容
                txtAesPwd.setText(decryptByPublicKey(encrypted_text, public_key));
                JOptionPane.showConfirmDialog(null, "合法签名，验证成功", "提示", JOptionPane.OK_OPTION);
            }else{
                JOptionPane.showMessageDialog(null, "签名不合法，验证失败", "错误", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    */
    ...
    public static String getPrivateKey(Map<String, Object> keyMap){
        try{
            ...
            return encodeBASE64(key.getEncoded()); //v1
    ...
    public static String decryptByPrivateKey(String data, String key){
        try {
            ...
            byte[] original = cipher.doFinal(decodeBASE64(data));
    ...
    public static String decryptByPublicKey(String data, String key){
        try{
            ...
            byte[] bytes = cipher.doFinal(decodeBASE64(data));
            //byte[] bytes = cipher.doFinal((new BASE64Decoder()).decodeBuffer(data)); // 正确方式
    ...
    public static String sign(String data, String privateKey){
        try{
            ...
            return encodeBASE64(signature.sign()); // v1
    ...
    */
    ...
    private javax.swing.JButton btnPrivateKeyDecrypt;
    private javax.swing.JButton btnPrivateKeyEncrypt;
    private javax.swing.JButton btnPublicKeyDecrypt;
    private javax.swing.JButton btnPublicKeyEncrypt;
